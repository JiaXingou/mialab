...
class ProteinBertModel(nn.Module):
    ...
    def forward(self, tokens, repr_layers=[], need_head_weights=False, return_contacts=False):
        ...
        if need_head_weights:
            ...
            if return_contacts:
######################################attentions，contact_head里才做apc和对称
                contacts,apc_sym_attentions = self.contact_head(tokens, attentions)
                result["contacts"] = contacts
                result["apc_sym_attentions"] = apc_sym_attentions
##########################################wt
        return result
